...
rm -rf ~/.claude/skills/lemon-content-writer
cp -r /tmp/lemon-agent-team/skills/lemon-content-writer ~/.claude/skills/
...
```bash
ls ~/.claude/skills/lemon-content-writer ~/.claude/skills/lemon-content-writer/references
```

确认以下文件全部存在：

- `~/.claude/skills/lemon-content-writer/SKILL.md`
- `~/.claude/skills/lemon-content-writer/references/编辑部通讯录.md`
- `~/.claude/skills/lemon-content-writer/references/游戏资讯日报_交付与流转规范.md`
